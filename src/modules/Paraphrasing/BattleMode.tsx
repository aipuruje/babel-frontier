...
const BATTLE_CHALLENGES: BattleChallenge[] = [
    {
        id: 1,
        name: 'Synonym Sprint',
        description: '8 synonym matches in 5 minutes',
        timeLimit: 300,
        questionCount: 8,
        difficulty: 'Easy',
        xpReward: 30
    },
    {
        id: 2,
        name: 'Paraphrase Pro',
        description: '12 paraphrase matches in 10 minutes',
        timeLimit: 600,
        questionCount: 12,
        difficulty: 'Medium',
        xpReward: 55
    },
    {
        id: 3,
        name: 'Lexical Master',
        description: '18 paraphrase matches in 15 minutes',
        timeLimit: 900,
        questionCount: 18,
        difficulty: 'Hard',
        xpReward: 85
...
export default function BattleMode() {
    ...
    useEffect(() => {
        const saved = localStorage.getItem('paraphrasing-battle-bests');
        if (saved) {
    ...
    const handleBattleComplete = useCallback(() => {
        ...
        if (simulatedAccuracy > currentBest) {
            ...
            localStorage.setItem('paraphrasing-battle-bests', JSON.stringify(newBests));
        }
        ...
        return (
            <div className="battle-active">
                ...
                <div className="battle-progress">
                    ...
                    <p>Match synonyms and paraphrases at lightning speed! Click below to simulate completion.</p>
    ...
    return (
        <motion.div className="battle-mode" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="battle-intro">
                ...
                <h2>Battle Mode</h2>
                <p>Speed-match synonyms and paraphrases! Test your lexical recognition under time pressure.</p>
            </div>
            ...
            {selectedChallenge && !battleActive && (
                <motion.div className="challenge-details" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    ...
                    <div className="detail-stats">
                        ...
                        <div className="detail-stat"><strong>{selectedChallenge.questionCount}</strong> matches</div>
                        <div className="detail-stat"><strong>{(selectedChallenge.timeLimit / selectedChallenge.questionCount / 60).toFixed(1)}</strong> min/match</div>
                    </div>
