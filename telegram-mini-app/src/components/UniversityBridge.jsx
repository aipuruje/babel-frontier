...
const UniversityBridge = () => {
    ...
    // const userName = window.Telegram?.WebApp?.initDataUnsafe?.user?.first_name || 'Student'; // Unused

    const checkEmbassyEligibility = useCallback(async () => {
    ...
    }, [checkEmbassyEligibility, loadPartners]);
