CREATE TABLE IF NOT EXISTS users (
  ...
  last_active TEXT DEFAULT CURRENT_TEXT,
  last_notified_at TEXT,
  target_date TEXT,
  initial_band_expectation REAL,
  momentum_score REAL DEFAULT 100.0,
  onboarding_status TEXT DEFAULT 'PENDING',
  boss_level_cleared INTEGER DEFAULT 0
) STRICT;
...
CREATE TABLE IF NOT EXISTS guild_members (
  ...
  joined_at TEXT DEFAULT CURRENT_TEXT,
...
CREATE TABLE IF NOT EXISTS regional_stats (
  ...
  last_updated TEXT DEFAULT CURRENT_TEXT
);
...
CREATE TABLE IF NOT EXISTS ai_generated_content (
  ...
  remediation_type TEXT, -- 'CC', 'LR', 'GRA', 'TR'
  generated_at TEXT DEFAULT CURRENT_TEXT,
...
CREATE TABLE IF NOT EXISTS event_participations (
  ...
  participated_at TEXT DEFAULT CURRENT_TEXT,
...
CREATE TABLE IF NOT EXISTS exam_attempts (
  ...
  started_at TEXT DEFAULT CURRENT_TEXT,
  completed_at TEXT,
...
CREATE TABLE IF NOT EXISTS exam_results (
  ...
  graded_at TEXT DEFAULT CURRENT_TEXT,
...
CREATE TABLE IF NOT EXISTS exam_reports (
  ...
  -- Delivery
  telegram_message_sent INTEGER DEFAULT 0,
  report_viewed INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS weekly_analytics (
  ...
  analyzed_at TEXT DEFAULT CURRENT_TEXT,
...
CREATE TABLE IF NOT EXISTS conversion_triggers (
  ...
  triggered_at TEXT DEFAULT CURRENT_TEXT,
  trigger_context TEXT, -- JSON with details
  modal_shown INTEGER DEFAULT 0,
  conversion_completed INTEGER DEFAULT 0,
...
-- ============================================
-- ANTIGRAVITY SOCIAL ENGINE (STEP 5)
-- ============================================

-- Create Pods (Small groups of 10-12 users)
...
-- Index for fast ranking by momentum (Social Lift efficiency)
CREATE INDEX IF NOT EXISTS idx_momentum_ranks ON users (momentum_score DESC);
